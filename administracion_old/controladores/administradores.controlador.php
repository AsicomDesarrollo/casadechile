				...
				if($respuesta){
					if($_POST["ingEmail"] == $respuesta["email"] && $_POST["ingPassword"] == $respuesta["password"]){
						...
						//if($_POST["ingEmail"] != "" && $_POST["ingPassword"] != ""){
							...
							echo '<br>
							<div class="alert alert-danger">Tu contraseña o usuario son incorrectos</div>';
					...
					echo '<br>
					<div class="alert alert-danger">Todos tus datos son incorrectos</div>';
