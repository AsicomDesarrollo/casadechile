...
class TablaEntradas{
  ...
  public function mostrarTablaEntradas(){	

  	$entradas = ControladorEntradas::ctrMostrarEntradas();
      ...
      $cancelar = "<span class='btn btn-danger' style='cursor: pointer;' onclick='Cancelar(this)' idAbono='".$entradas[$i]["id"]."'><i class='fa fa-trash-o'></i> Cancelar</span>";
      ...
      }else if($entradas[$i]["estatus"] == "Cancelada") {
        
        $estatus = "<span class='btn btn-default' style='padding-top: 0px; padding-bottom: 0px; border-radius:15px;cursor: default;'>Cancelada</span>";
      ...
      $fechaOrdenada = explode("-", $datosFecha[0]);
          ...
          if($entradas[$i]["estatus"] != "Cancelada"){
...
=============================================*/ 
$activarProductos = new TablaEntradas();
$activarProductos -> mostrarTablaEntradas();