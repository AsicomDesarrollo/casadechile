  ...
  <section class="content-header">
   ...
   <h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nueva orden de servicio</li>
...
<div id="modalClientes" class="modal fade bd-example-modal-lg" role="dialog" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <span class="btn btn-success pull-right" id="nuevoCliente">Nuevo cliente</button>
