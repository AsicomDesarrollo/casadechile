...
static public function ctrActualizarProd($productoId,$productoNombre,$productoPrecio,$productoPrecioMin,$productoPrecioMax, $productoCategoria){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlActualizarProd($tabla, $productoId,$productoNombre,$productoPrecio,$productoPrecioMin,$productoPrecioMax, $productoCategoria);
...
static public function ctrInsertarProd($nombre,$precio,$preciomin,$preciomax,$categoria){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlInsertarProd($tabla, $nombre, $precio, $preciomin, $preciomax, $categoria);
...
static public function ctrTraerProductosPorCategoria($categoria){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlTraerProductosPorCategoria($tabla,$categoria);
