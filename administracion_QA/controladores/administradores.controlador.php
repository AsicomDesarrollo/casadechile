		...
		if(isset($_POST["ingEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["ingEmail"]) &&
			   ...
			   #$encriptar = crypt($_POST["ingPassword"], '$2a$07$asxx54ahjppf45sd87a5a4dDDGsystemdev$');
				...
				$respuesta = ModeloAdministradores::mdlMostrarAdministradores($tabla, $valor);

				if(empty($respuesta) || $respuesta=='' || !isset($respuesta )){
					echo '<br> <br>  <div class="alert alert-danger">Error al ingresar vuelva a intentarlo. </div>';
					print_r("sadsad");
					print_r($respuesta);
					exit();
				}
