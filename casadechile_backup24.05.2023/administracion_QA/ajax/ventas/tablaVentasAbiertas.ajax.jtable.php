...
class TablaVentas{
  ...
  public function mostrarTabla(){	
    ...
    $stmt_total= Conexion::conectar()->prepare("select count(folio) totalTikets from venta_tiket WHERE estatus = 'abierto' ");
    $stmt_total-> execute();
    ...
    //? Trae todas las ventas abiertas y filtra por controles.
		$stmt = Conexion::conectar()->prepare("SELECT * FROM venta_tiket WHERE estatus = 'abierto' ".$orden." limit ".$limitInf.",". $limitSup);
		$stmt -> execute();
